    ...
    public static function getCliMessages(): array
    {
        return [
            ...
            'ko' => [
                ...
                'plugin_path_conflict' => "<error>`--plugin/-p`와 `--path/-P`가 모두 지정되었으나 일치하지 않습니다.\n예상: {expected}\n실제: {actual}\n둘 중 하나만 지정하거나 동일하게 맞추세요.</error>",
            ...
            'es' => [
                ...
                'plugin_path_conflict' => "<error>Se han indicado `--plugin/-p` y `--path/-P` pero son inconsistentes.\nEsperado: {expected}\nReal: {actual}\nIndique solo uno o hágalos coincidir.</error>",
            ...
            'pt_BR' => [
                ...
                'plugin_path_conflict' => "<error>`--plugin/-p` e `--path/-P` foram informados mas são inconsistentes.\nEsperado: {expected}\nAtual: {actual}\nInforme apenas um ou deixe-os iguais.</error>",
            ...
            'ru' => [
                ...
                'plugin_path_conflict' => "<error>Указаны и `--plugin/-p`, и `--path/-P`, но значения не совпадают.\nОжидалось: {expected}\nУказано: {actual}\nУкажите один вариант или приведите к одному значению.</error>",
            ...
            'vi' => [
                ...
                'plugin_path_conflict' => "<error>Đã chỉ định cả `--plugin/-p` và `--path/-P` nhưng không nhất quán.\nMong đợi: {expected}\nThực tế: {actual}\nChỉ cung cấp một trong hai hoặc làm cho chúng trùng nhau.</error>",
            ...
            'tr' => [
                ...
                'plugin_path_conflict' => "<error>`--plugin/-p` ve `--path/-P` birlikte verilmiş ancak tutarsız.\nBeklenen: {expected}\nGerçek: {actual}\nYalnız birini verin veya aynı yapın.</error>",
            ...
            'id' => [
                ...
                'plugin_path_conflict' => "<error>`--plugin/-p` dan `--path/-P` sama-sama diberikan tetapi tidak konsisten.\nHarapan: {expected}\nActual: {actual}\nBerikan salah satu saja atau samakan.</error>",
            ...
            'th' => [
                ...
                'plugin_path_conflict' => "<error>ระบุทั้ง `--plugin/-p` และ `--path/-P` แต่ไม่สอดคล้องกัน\nที่คาดหวัง: {expected}\nที่ระบุ: {actual}\nกรุณาระบุอย่างใดอย่างหนึ่งหรือให้ตรงกัน</error>",
